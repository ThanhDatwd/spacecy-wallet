...
export interface AutoCompleteCustomProps {
	currentItem: OptionSelectCustom<any> | undefined | null;
...
function AutoCompleteCustom({
	...
	const { getRootProps, getInputProps, getListboxProps, getOptionProps, groupedOptions, value } =
		useAutocomplete({
			id: 'autocomplete',
			options: listItem,
			getOptionLabel: (option: OptionSelectCustom<any>) => String(option.name),
			isOptionEqualToValue: (
				option: OptionSelectCustom<any>,
				value: OptionSelectCustom<any>
