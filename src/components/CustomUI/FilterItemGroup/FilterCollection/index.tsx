...
import iconCollectionBlack from 'assets/icons/icon-filter-collection.svg';
// models
...
export default function FilterCollection({ filter, setFilter, resetAll }: IFilterCollectionProps) {
	...
	const renderDropdownContent = () => {
		return (
			<DropdownWrapper sx={{ minWidth: '320px' }}>
				<FieldInput
					type="text"
				...
				{isLoading ? (
					...
					<ListOption sx={{ mt: 0.5, width: '92%', mx: 'auto' }}>
				...
				<DropdownButtonGroup>
					...
					<ButtonWhite onClick={handleApply} type="submit" sx={{ width: '130px' }}>
						Apply
					</ButtonWhite>
				</DropdownButtonGroup>
			</DropdownWrapper>
