...
import { ServiceFee } from '../../../constants/common.constant';
...
export default function FormMintNft({ onSubmit }: IFormOfferProps) {
		...
		<form onSubmit={handleSubmit(onSubmit)}>
			...
			<Box fontStyle="italic">
				...
				<Stack direction="row" justifyContent="space-between" sx={{ mt: 1 }}>
					<Typography variant="body2">Service fee {ServiceFee}% :</Typography>
				...
				<Typography variant="h6" fontWeight="500" sx={{ mt: 2, mb: 0.5 }}>
					Expiration
				</Typography>
				...
				<Box sx={{ width: '35%', mx: 'auto', mt: '15px' }}>
					<ButtonWhite type="submit" disabled={isSubmitting} sx={{ mt: 2, mb: 3 }}>
						{isSubmitting && (
