...
const listTutorial = [
	...
	},
	{
		...
		image: Collection,
		link: RELATED_URLS.tutorialCreateCollectible,
	},
	{
		id: 3,
		title: '3. Add Your NFTs',
		description:
			'Upload your category (image, video, audio, or 3D art), add a title and description, and customize your NFTs with properties and stats.',
		image: NFTs,
		link: RELATED_URLS.tutorialAddNFT,
	},
	{
		id: 4,
