...
import CardBlueIcon from 'assets/icons/icon-offer-blue.svg';
...
export default function ButtonOffer({ personalOffer, loadingPersonalOffer }: IButtonOfferProps) {
	...
	return (
		<>
			{isQualifiedToOffer() && (
				<ButtonWhite onClick={() => setModalOffer(true)} sx={{ width: '120px', mb: 0 }}>
					{/* {isLightTheme ? (
						<img src={CardIcon} alt="card icon" height={16} width={22} />
					) : (
						<img src={CardBlueIcon} alt="card icon" height={16} width={22} />
					)} */}
