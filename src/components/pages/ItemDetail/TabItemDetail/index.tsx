...
import inConPropertiesBlack from 'assets/icons/properties-black.svg';
...
import inConPropertiesBlue from 'assets/icons/properties-blue.svg';
	...
	const tabsDetail = {
		items: [
			...
			},
			{
				title: 'Properties',
				icon: isLightTheme ? (
					<img src={inConPropertiesBlack} alt="graph icon" width={32} height={15} />
				) : (
					<img src={inConPropertiesBlack} alt="graph icon" width={32} height={15} />
				),
				iconSelected: (
					<img src={inConPropertiesBlue} alt="graph icon" width={32} height={15} />
				),
				isShow: true,
			},
		],
		sections: [
			...
			{
				Section: <PropertiesTab item={item} />,
				isShow: true,
			},
		],
	};
