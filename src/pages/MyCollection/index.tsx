...
function MyCollection() {
	...
	const executeAfterFetchAllCollection = (globalStateNewest: RootState) => {
		...
		if (!collection.isSuccess) {
			toast.error('Some error occur when getting all collections!');
		}
	};
	...
	return (
		<Container maxWidth="xxl" sx={{ mt: 14 }}>
			...
			<Typography variant="body1">
				Create, curate and manage NFT collections to share and sell in the marketplace.
			</Typography>
			...
			>
				...
				{/* <Box sx={{ width: '230px' }}>
					...
					<Modal
						onOpen={modal}
						mainHeader="Import A Collection"
